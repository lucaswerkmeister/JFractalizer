...
public interface ZoomableFractal extends Fractal {
	...
	/**
	 * Zooms the fractal to the specified center with the specified zoom factor. If the resulting area goes outside the
	 * start area, it is moved to best fit a start area.
	 * 
	 * @param x
	 *            The x coordinate of the point that is to become the new center, in pixels.
	 * @param y
	 ...
	 * <p>
	 * Calling <code>fractal.zoomToStart(centerX, centerY, fractal.getZoomFactor())</code> should, rounding errors
	 * aside, always yield a starting image.
	 * 
