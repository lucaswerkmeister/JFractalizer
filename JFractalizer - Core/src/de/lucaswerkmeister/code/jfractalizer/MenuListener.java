	...
	public void actionPerformed(final ActionEvent event)
	{
		switch (event.getActionCommand())
		{
			...
			case "Save Setup":
				...
				if (result == JFileChooser.APPROVE_OPTION)
					try
					{
						...
						hd.startDocument();
						MainFrame.getInstance().getCurrentProvider().saveFractXml(hd);
						hd.endDocument();
						out.close();
					}
			...
			case "Load Setup":
				...
				break;
			case "Choose Fractal...":
				final ClassChooserDialog<FractalProvider> fractalChooserDialog = new ClassChooserDialog<>(MainFrame.getInstance(), "Choose Fractal",
						FractalProvider.class);
				fractalChooserDialog.setVisible(true);
				MainFrame.getInstance().setCurrentProvider(fractalChooserDialog.getSelectedService());
				break;
			case "Choose Color Palette...":
				final ClassChooserDialog<ColorPalette> colorPaletteDialog = new ClassChooserDialog<>(MainFrame.getInstance(), "Choose Color Palette",
						ColorPalette.class);
