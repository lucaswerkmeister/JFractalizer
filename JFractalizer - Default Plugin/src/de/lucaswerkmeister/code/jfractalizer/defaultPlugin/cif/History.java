...
/**
 * The <code>History</code> class provides methods to store a specific state of
 * anything and moving back and forth between different states of it. After a
 * specified number of states, old states are either discarded or stored to the
 * hard disk.
 * 
