...
/**
 * A CifImageMaker draws a snapshot of a CIF (Complex Iterative Fractal) onto a
 * specified graphics. Different implementations may use several optimizations.
 * 
...
public abstract class CifImageMaker extends Thread {
	 ...
	 *            before it is considered a member of the fractal.
	 * @param targetImage
	...
	protected static final int mandelbrotPasses_notFinal(final double cReal,
			final double cImag, final int maxPasses) {
		double zReal = 0, zImag = 0, zRealNew = 0;
		int passes = 0;
		double zRealSquared = 0;
	...
	protected static final int mandelbrotPasses_final(final double cReal,
			final double cImag, final int maxPasses) {
	...
	protected static final int mandelbrotPasses_twoPass(final double cReal,
			final double cImag, final int maxPasses) {
	...
	protected static final int juliaPasses(double zReal, double zImag,
			final double cReal, final double cImag, final int maxPasses) {
		int passes = 0;
